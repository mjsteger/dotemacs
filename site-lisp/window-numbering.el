...
(defvar window-numbering-keymap
  (let ((map (make-sparse-keymap)))
    (define-key map (kbd "C-c !") 'select-window-0)
    (define-key map (kbd "C-c @") 'select-window-1)
    (define-key map (kbd "C-c #") 'select-window-2)
    (define-key map (kbd "C-c $") 'select-window-3)
    (define-key map (kbd "C-c %") 'select-window-4)
    (define-key map (kbd "C-c ^") 'select-window-5)
    (define-key map (kbd "C-c &") 'select-window-6)
    (define-key map (kbd "C-c *") 'select-window-7)
    (define-key map (kbd "C-c (") 'select-window-8)
    (define-key map (kbd "C-c )") 'select-window-9)
    map)
